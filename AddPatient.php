					...
					<div class="row mb-3">
						<div class="col">
							<label for="first-name" class="form-label">First Name</label> <input
								...
								name="first-name" pattern="[A-Za-z]+"
								title="Please enter letters only." placeholder="First Name"
					...
					<div class="row mb-3">
						<div class="col">
							<input type="text" class="form-control" placeholder="City"
								id="city" name="city" pattern="[A-Za-z]+" required>
						</div>
						<div class="col">
						...
						<div class="col">
							<input type="text" class="form-control" placeholder="Country"
								id="country" name="country" pattern="[A-Za-z]+" maxlength="14"
								required>
						</div>
					</div>
