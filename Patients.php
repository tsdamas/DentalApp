...
<body class="bg-light">
	...
	<div class="container mt-5">
		...
		<div class="d-flex justify-content-between mb-3">
			<a href="AddPatient.php" class="btn btn-primary">Add Patient</a> <a
				href="RemovePatient.php" class="btn btn-danger">Remove Patient</a>
		</div>
			...
			<table class="table table-light table-striped table-hover">
				...
				<tbody>
                    <?php while ($row = mysqli_fetch_assoc($result)): ?>
                        <tr>
						<td><a
							href="PatientProfile.php?patient_id=<?php echo $row['ID']; ?>"><?php echo htmlspecialchars($row['ID']); ?></a></td>
